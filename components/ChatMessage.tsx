    ...
    return (
        <div className={`w-full flex ${isUser ? 'justify-end' : 'justify-start'} animate-in fade-in slide-in-from-bottom-2 duration-500`}>
            ...
            >
                ...
                {/* Botones de acción */}
                {!isUser && (onSpeak || onColectivizar || onCalendizar) && (
                    <div className="self-start flex items-center gap-2 flex-wrap">
                        ...
                        {onCalendizar && (
                            <button
                                onClick={onCalendizar}
                                className="p-2 text-gray-400 hover:text-[#4285F4] hover:bg-white rounded-lg transition-all flex items-center gap-2 text-xs font-medium border border-gray-200 hover:border-[#4285F4] bg-white/50 hover:shadow-sm"
